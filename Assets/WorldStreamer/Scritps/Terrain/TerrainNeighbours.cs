...
public class TerrainNeighbours : MonoBehaviour
{
	...
	public void CreateNeighbours ()
	{
		...
		Dictionary<int[], Terrain> _terrainDictNew = new Dictionary<int[], Terrain> (new IntArrayComparer ());
		Dictionary<int[], Terrain> _terrainDictRob2 = new Dictionary<int[], Terrain> (new IntArrayComparer ());
