												...
												if (_effect.quality != BEAUTIFY_QUALITY.Basic) {
																...
																if (testFeatureEnabled (isDoFEnabled)) {
																				...
																				if (expandDoFSection) {
																								...
																								EditorGUILayout.EndHorizontal ();
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Label(new GUIContent("   Clamp Brightness", "Clamps maximum pixel brightness to prevent out of range bright spots."), GUILayout.Width(120));
                        _effect.depthOfFieldMaxBrightness = EditorGUILayout.FloatField(_effect.depthOfFieldMaxBrightness, GUILayout.Width(80));
                        EditorGUILayout.EndHorizontal();
